...
# Switches
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {B[0]}];  # Switch 0
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {B[1]}];  # Switch 1
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {B[2]}];  # Switch 2
set_property -dict {PACKAGE_PIN W17 IOSTANDARD LVCMOS33} [get_ports {B[3]}];  # Switch 3
#set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {NA[3]}];  # Switch 4
...
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {en}];  # Switch 7 Enable
...
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {A[2]}];  # Switch 14 
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports {A[3]}];  # Switch 15 

# LEDs
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {B_led[0]}];  # LED 0
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {B_led[1]}];  # LED 1
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {B_led[2]}];  # LED 2
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {B_led[3]}];  # LED 3
#set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {A_led[4]}];  # LED 4
#set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports {zero_led}];  # LED 5
#set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {overflow_led}];  # LED 6
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports {enable}];  # LED 7
set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports {A_led[0]}];  # LED 13
set_property -dict {PACKAGE_PIN N3 IOSTANDARD LVCMOS33} [get_ports {A_led[1]}];  # LED 13
set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports {A_led[2]}];  # LED 14
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports {A_led[3]}];  # LED 15
