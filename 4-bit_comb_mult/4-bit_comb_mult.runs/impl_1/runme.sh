...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/4-bit_comb_mult/4-bit_comb_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_stage_pipeline_mult_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_stage_pipeline_mult_fpga.tcl -notrace
