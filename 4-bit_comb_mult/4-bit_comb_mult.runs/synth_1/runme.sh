...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/4-bit_comb_mult/4-bit_comb_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_stage_pipeline_mult_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_stage_pipeline_mult_fpga.tcl
