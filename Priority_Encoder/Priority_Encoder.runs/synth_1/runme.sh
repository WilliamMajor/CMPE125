...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/Priority_Encoder/Priority_Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder_fpga.tcl
