...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/Priority_Encoder/Priority_Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder_fpga.tcl -notrace
