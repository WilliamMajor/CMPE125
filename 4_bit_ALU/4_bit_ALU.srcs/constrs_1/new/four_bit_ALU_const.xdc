...
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports {s0}];  # Switch 13 (control)
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {s1}];  # Switch 14 (control)
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports {m}];  # Switch 15 (control)

# LEDs
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {out_led[0]}];  # LED 0
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {out_led[1]}];  # LED 1
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {out_led[2]}];  # LED 2
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {out_led[3]}];  # LED 3
...
set_property -dict {PACKAGE_PIN N3 IOSTANDARD LVCMOS33} [get_ports {s0_led}];  # LED 13
set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports {s1_led}];  # LED 14
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports {m_led}];  # LED 15
