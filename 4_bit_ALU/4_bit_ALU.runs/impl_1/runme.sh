...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/4_bit_ALU/4_bit_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_ALU_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_bit_ALU_fpga.tcl -notrace
