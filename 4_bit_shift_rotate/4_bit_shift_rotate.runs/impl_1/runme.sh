...
HD_PWD='C:/Users/William Major/Documents/School/Cmpe 125 Projects/4_bit_shift_rotate/4_bit_shift_rotate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_shift_rotate_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_bit_shift_rotate_fpga.tcl -notrace
