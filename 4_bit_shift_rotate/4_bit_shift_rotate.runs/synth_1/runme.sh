...
HD_PWD='C:/Users/William Major/Documents/School/Cmpe 125 Projects/4_bit_shift_rotate/4_bit_shift_rotate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_shift_rotate_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_shift_rotate_fpga.tcl
