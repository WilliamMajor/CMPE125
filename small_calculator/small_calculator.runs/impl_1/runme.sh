...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/small_calculator/small_calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log small_calculator_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source small_calculator_fpga.tcl -notrace
