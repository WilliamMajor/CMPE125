...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/small_calculator/small_calculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log small_calculator_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source small_calculator_fpga.tcl
