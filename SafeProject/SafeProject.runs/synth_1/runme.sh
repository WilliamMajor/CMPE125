...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/SafeProject/SafeProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Calc_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_Calc_FPGA.tcl
