...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/SafeProject/SafeProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Calc_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Calc_FPGA.tcl -notrace
