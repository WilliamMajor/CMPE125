...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/4_bit_uint_divider/4_bit_uint_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Divider_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Divider_fpga.tcl -notrace
