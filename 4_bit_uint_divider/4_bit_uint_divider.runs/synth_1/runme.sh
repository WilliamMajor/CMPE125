...
HD_PWD='D:/Documents HDD/School/Cmpe 125/Cmpe 125 Projects/4_bit_uint_divider/4_bit_uint_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Divider_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Divider_fpga.tcl
